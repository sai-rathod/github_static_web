...
console.log('%c🚀 Task 06 - Elevate Labs', 'color: #6366f1; font-size: 24px; font-weight: bold;');
console.log('%cThanks for checking out my code! 👨‍💻', 'color: #8b5cf6; font-size: 16px;');
